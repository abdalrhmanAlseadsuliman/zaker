        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form id="MyParyersNumber" class = "mt-2">
    ...
    <script>
       ...
       window.addEventListener('load', async function() {
        ...
        try {
            ...
            data: prayersData,
            columns: [
                { title: "ترتيب", data: null, render: function (data, type, row, meta) { return meta.row + 1; } },
                { title: "عدد الصلوات", data: "NumberPrayers" },
                { title: "التاريخ", data: "Date" }
            ]
            });

            createChart(prayersData);
            createBarChart(prayersData);
